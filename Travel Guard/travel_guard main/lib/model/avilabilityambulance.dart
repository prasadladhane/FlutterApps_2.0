...
class Availabilityambulance extends StatefulWidget {
  final String userLocation;

  // const Availabilityambulance({Key? key, required this.userLocation}) : super(key: key);
  const Availabilityambulance({super.key,required this.userLocation});

  @override
  State<Availabilityambulance> createState() => _AvailabilityState();
}

class _AvailabilityState extends State<Availabilityambulance> {
  ...
  Future<List<Map<String, dynamic>>> fetchAmbulances() async {
    QuerySnapshot<Map<String, dynamic>> querySnapshot = await FirebaseFirestore.instance
        ...
        .where('serviceType', isEqualTo: 'Ambulance')
  ...
  Future<void> _sendRequestToAmbulance(String ambulanceId) async {
    final requestData = {
      'Problem': 'Medical Emergency', // Replace with user input
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No ambulances found for your location.'));
          }
