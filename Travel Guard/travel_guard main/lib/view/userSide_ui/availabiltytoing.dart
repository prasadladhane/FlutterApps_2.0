...
class Availabilitytoing extends StatefulWidget {
  final String userLocation;

  const Availabilitytoing({Key? key, required this.userLocation}) : super(key: key);

  @override
  State<Availabilitytoing> createState() => _AvailabilityState();
}

class _AvailabilityState extends State<Availabilitytoing> {
  ...
  Future<List<Map<String, dynamic>>> fetchAmbulances() async {
    QuerySnapshot<Map<String, dynamic>> querySnapshot = await FirebaseFirestore.instance
        ...
        .where('serviceType', isEqualTo: 'Towing Van')
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('No Towing Van found for your location.'));
          }
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                _sendRequestToMechanic(ambulance['id']);
