                    ...
                    Column(
                      children: [
                        buildInfoTile(
                          ...
                          //null aware operator
                          //If userData?['email'] is null (either because userData was null or
                          // the 'email' key doesn't exist), it evaluates to "N/A".
                        ),
                        buildInfoTile(
...
//           await saveUserDataToLocalDatabase(userData!);
//         } else {
//           setState(() {
//             isLoading = false;
//           });
...
//   Future<void> saveUserDataToLocalDatabase(Map<String, dynamic> userData) async {
...
//                     // Display data from the local database
//                     Text(
//                       userData?['name'] ?? "User Name",
//                       style: GoogleFonts.quicksand(fontSize: 22, fontWeight: FontWeight.w600),
//                     ),
//                     // Other UI components like email, phone, etc.
//                   ],
//                 ),
//               ),
//             ),
